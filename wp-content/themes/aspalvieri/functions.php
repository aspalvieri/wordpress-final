...
/**
 * Games
 * Displays games that are for sale.
 * Sort of like a shop.
 */
function games_init() {
	$args = array(
...
// Games Shortcode
function games_query() {
	$query = new WP_Query(array("post_type" => "games", "posts_per_page" => 4));
	while ($query -> have_posts()) : $query -> the_post();
	echo "<div class='game-store-short'>";
		...
		echo "<div class='game-store-content'>";
			echo "<h3>";
				the_title();
			echo "</h3>";
			echo "<p>$".get_field("game-price", get_the_ID())."</p>";
...
function games_shortcode() {
	add_shortcode("games_shortcode", "games_query");
}
add_action("init", "games_shortcode");

function game_reviews_query() {
...
function game_reviews_shortcode() {
	add_shortcode("game_reviews_shortcode", "game_reviews_query");
}
add_action("init", "game_reviews_shortcode");